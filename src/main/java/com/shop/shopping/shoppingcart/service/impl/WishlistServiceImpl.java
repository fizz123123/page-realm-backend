package com.shop.shopping.shoppingcart.service.impl;
...
import com.shop.shopping.shoppingcart.dto.response.WishItemResponse;
import com.shop.shopping.shoppingcart.dto.response.WishResponse;
import com.shop.shopping.shoppingcart.entity.*;
import com.shop.shopping.shoppingcart.repository.*;
import com.shop.shopping.shoppingcart.service.WishlistService;
...
public class WishlistServiceImpl implements WishlistService {
    ...
    public void addItemToWish(Long userId, AddItemToWishRequest request) {
        ...
        if (!exists) {
            Books book = booksRepository.findById(request.getBookId()).orElseThrow();
            WishlistItems newItem = new WishlistItems();
            newItem.setBook(book);
    ...
    public void addItemToCartfromWish(Long userId, AddItemToCartfromWishRequest request) {
        ...
        while (iterator.hasNext()) {
            ...
            if (item.getId() != null && wishItemIds.contains(item.getId())) {
                ...
                Books book = booksRepository.findById(item.getBook().getId()).orElseThrow();
                ...
                newItem.setSnapshotPrice(book.getPrice());
